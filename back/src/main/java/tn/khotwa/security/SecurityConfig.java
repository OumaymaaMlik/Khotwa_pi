    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // ── TALENT MARKET : lecture publique ────────────────────────
                        ...
                        // ── MULTI-ROLES ──────────────────────────────────────────────
                        .requestMatchers("/api/users/**").hasAnyRole("ADMIN", "ENTREPRENEUR", "COACH", "VISITOR")
                        .requestMatchers("/api/talents/**").hasAnyRole("ADMIN", "ENTREPRENEUR", "COACH", "VISITOR")
                        .requestMatchers("/api/candidatures/**").hasAnyRole("ADMIN", "ENTREPRENEUR", "COACH", "VISITOR")
                        .requestMatchers("/api/matching/**").hasAnyRole("ADMIN", "ENTREPRENEUR", "COACH", "VISITOR")
                        ...
                        .requestMatchers("/api/evenement/**").hasAnyRole("ADMIN", "ENTREPRENEUR", "COACH")
