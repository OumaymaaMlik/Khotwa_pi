...
import tn.khotwa.entity.projectEntity.ProjetCoach;
...
public class DtoMapper {
    ...
    public ProjetResponseDto toProjetResponse(Projet projet) {
        return ProjetResponseDto.builder()
                ...
                .entrepreneurNomAffiche(projet.getEntrepreneur() != null ? projet.getEntrepreneur().getFirstName() : null)
    ...
    public ProjetCoachResponseDto toProjetCoachResponse(ProjetCoach pc) {
        return ProjetCoachResponseDto.builder()
            ...
            .coachNomAffiche(pc.getCoach() != null ? pc.getCoach().getFirstName() : null)
