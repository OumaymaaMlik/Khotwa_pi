...
import tn.khotwa.exception.User.LastAdminDeletionException;
...
public class UserServiceImpl implements UserService {
    ...
    public List<EntrepreneurSelectionResponse> getEntrepreneursForCollaboration(String search) {
        return userRepository.findAllByRoleWithSearch(Role.ENTREPRENEUR, search)
            .stream()
            .map(user -> new EntrepreneurSelectionResponse(
                user.getIdUser(),
                user.getFullName(),
