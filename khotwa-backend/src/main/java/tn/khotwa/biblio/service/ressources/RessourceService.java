...
import tn.khotwa.biblio.projection.ressources.*;
import tn.khotwa.biblio.repository.ressources.*;
import tn.khotwa.biblio.service.AccessControlService;
...
public class RessourceService implements IRessourceService {
    ...
    private void gererTags(Ressource r, List<String> tagNames) {
        if (tagNames == null || tagNames.isEmpty()) { r.setTags(new ArrayList<>()); return; }
