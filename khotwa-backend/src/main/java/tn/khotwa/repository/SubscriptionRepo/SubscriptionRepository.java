...
public interface SubscriptionRepository extends JpaRepository<Subscription, Long> {
    ...
    List<Subscription> findByStatutAndDateFinBefore(
            ...
            LocalDate date);
    List<Subscription> findByStatutAndDateFinLessThanEqual(
            SubscriptionStatus statut,
            LocalDate date);
    Optional<Subscription> findByUser_IdUser(Long userId);
    List<Subscription> findAllByUser_IdUser(Long userId);
    Optional<Subscription> findTopByUser_IdUserOrderByIdSubscriptionDesc(Long userId);


    Optional<Subscription> findByUser_IdUserAndStatutIn(Long userId, List<SubscriptionStatus> statuts);
    Optional<Subscription> findTopByUser_IdUserAndStatutInOrderByIdSubscriptionDesc(Long userId, List<SubscriptionStatus> statuts);
    boolean existsByUser_IdUserAndStatut(Long userId, SubscriptionStatus statut);
