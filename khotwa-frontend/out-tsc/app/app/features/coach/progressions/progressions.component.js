...
function CoachProgressionsComponent_div_28_Template(rf, ctx) { if (rf & 1) {
...
function CoachProgressionsComponent_div_29_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 20);
    i0.ɵɵtext(1, "Loading\u2026");
    i0.ɵɵelementEnd();
} }
function CoachProgressionsComponent_div_30_div_5_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function CoachProgressionsComponent_div_30_div_5_Template_button_click_16_listener() { const p_r3 = i0.ɵɵrestoreView(_r2).$implicit; const ctx_r0 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r0.marquerTermine(p_r3)); });
...
function CoachProgressionsComponent_div_30_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 21)(1, "h3", 22);
    i0.ɵɵelement(2, "span", 23);
    i0.ɵɵtext(3);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(4, "div", 24);
    i0.ɵɵtemplate(5, CoachProgressionsComponent_div_30_div_5_Template, 18, 9, "div", 25);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵadvance(3);
...
function CoachProgressionsComponent_div_31_div_5_Template(rf, ctx) { if (rf & 1) {
...
function CoachProgressionsComponent_div_31_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 38)(1, "h3", 22);
    i0.ɵɵelement(2, "span", 39);
    i0.ɵɵtext(3);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(4, "div", 24);
    i0.ɵɵtemplate(5, CoachProgressionsComponent_div_31_div_5_Template, 13, 6, "div", 40);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵadvance(3);
...
function CoachProgressionsComponent_div_32_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function CoachProgressionsComponent_div_32_Template_button_click_5_listener() { i0.ɵɵrestoreView(_r5); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.openBibliotheque()); });
    i0.ɵɵtext(6, "Browse the Library \u2192");
    i0.ɵɵelementEnd()();
} }
export class CoachProgressionsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CoachProgressionsComponent, selectors: [["app-coach-progressions"]], decls: 33, vars: 9, consts: [[1, "page", "animate-1"], [1, "page-header"], [1, "kh-page-title"], [1, "page-sub"], [1, "kh-btn", "kh-btn--primary", 3, "click"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"], ["d", "M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"], [1, "prog-kpis", "animate-2"], [1, "prog-kpi"], [1, "prog-kpi__val", 2, "color", "var(--teal)"], [1, "prog-kpi__label"], [1, "prog-kpi__val", 2, "color", "var(--green)"], [1, "prog-kpi__val"], ["class", "prog-kpi", 4, "ngIf"], ["style", "text-align:center;padding:40px;color:var(--text-muted)", 4, "ngIf"], ["class", "animate-3", 4, "ngIf"], ["class", "animate-3", "style", "margin-top:24px", 4, "ngIf"], ["class", "empty-prog", 4, "ngIf"], [1, "prog-kpi__val", 2, "color", "var(--orange)"], [2, "text-align", "center", "padding", "40px", "color", "var(--text-muted)"], [1, "animate-3"], [1, "section-title"], [1, "section-dot", 2, "background", "var(--teal)"], [1, "prog-list"], ["class", "prog-card kh-card", 4, "ngFor", "ngForOf"], [1, "prog-card", "kh-card"], [1, "prog-card__left"], [1, "prog-card__icon"], [1, "prog-card__info"], [1, "prog-card__titre"], [1, "prog-card__meta"], [1, "prog-card__right"], [1, "prog-bar-wrap"], [1, "kh-progress", 2, "width", "120px", "height", "8px"], [1, "kh-progress__fill", 2, "background", "var(--teal)"], [1, "prog-pct-label"], [1, "kh-btn", "kh-btn--ghost", "kh-btn--sm", 3, "click"], [1, "animate-3", 2, "margin-top", "24px"], [1, "section-dot", 2, "background", "var(--green)"], ["class", "prog-card kh-card prog-card--done", 4, "ngFor", "ngForOf"], [1, "prog-card", "kh-card", "prog-card--done"], [1, "done-badge"], [1, "empty-prog"]], template: function CoachProgressionsComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵlistener("click", function CoachProgressionsComponent_Template_button_click_7_listener() { return ctx.openBibliotheque(); });
            i0.ɵɵnamespaceSVG();
            ...
            i0.ɵɵelementEnd()();
            i0.ɵɵtemplate(28, CoachProgressionsComponent_div_28_Template, 6, 4, "div", 14);
            i0.ɵɵelementEnd();
            i0.ɵɵtemplate(29, CoachProgressionsComponent_div_29_Template, 2, 0, "div", 15)(30, CoachProgressionsComponent_div_30_Template, 6, 2, "div", 16)(31, CoachProgressionsComponent_div_31_Template, 6, 2, "div", 17)(32, CoachProgressionsComponent_div_32_Template, 7, 0, "div", 18);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵadvance(6);
