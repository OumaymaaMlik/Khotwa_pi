...
function CoachStartupsComponent_div_7_Template(rf, ctx) { if (rf & 1) {
...
export class CoachStartupsComponent {
    ...
    static { this.ɵfac = function CoachStartupsComponent_Factory(t) { return new (t || CoachStartupsComponent)(i0.ɵɵdirectiveInject(i1.ProjetService)); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CoachStartupsComponent, selectors: [["app-coach-startups"]], decls: 8, vars: 2, consts: [[1, "page", "animate-1"], [1, "page-header"], [1, "kh-page-title"], [1, "page-sub"], [1, "grid", "animate-2"], ["class", "card kh-card", 4, "ngFor", "ngForOf"], [1, "card", "kh-card"], [2, "display", "flex", "justify-content", "space-between", "align-items", "flex-start", "margin-bottom", "14px"], [1, "startup-icon"], [1, "kh-badge"], [1, "card-name"], [1, "card-meta"], [2, "margin", "14px 0 8px"], [2, "display", "flex", "justify-content", "space-between", "margin-bottom", "5px"], [2, "font-size", "11px", "color", "var(--text-muted)"], [2, "font-size", "12px"], [1, "kh-progress"], [1, "kh-progress__fill", "kh-progress__fill--teal"], [2, "display", "flex", "gap", "8px", "padding-top", "12px", "border-top", "1px solid var(--border)"], [1, "kh-btn", "kh-btn--ghost", "kh-btn--sm"], [1, "kh-btn", "kh-btn--sm", 2, "background", "var(--violet)", "color", "white"]], template: function CoachStartupsComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵtemplate(7, CoachStartupsComponent_div_7_Template, 23, 9, "div", 5);
            i0.ɵɵelementEnd()();
        } if (rf & 2) {
            i0.ɵɵadvance(5);
