...
export class ProjetService {
    ...
    get projets() { return this._projets; }
    get projetsActifs() { return this._projets.filter(p => p.statut === 'in_progress'); }
    getById(id) { return this._projets.find(p => p.id === id); }
    ...
    delete(id) { this._projets = this._projets.filter(p => p.id !== id); }
    static { this.ɵfac = function ProjetService_Factory(t) { return new (t || ProjetService)(); }; }
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: ProjetService, factory: ProjetService.ɵfac, providedIn: 'root' }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ProjetService, [{
        type: Injectable,
