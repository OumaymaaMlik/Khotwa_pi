...
const MOCK: Projet[] = [
  ...
  { id:'p2', titre:'HealthMobile App', description:'Health app for patient tracking', status:'in_progress', progression:30, entrepreneurId:'u2', coachId:'u3', etapes:[], createdAt:new Date('2024-03-01'), updatedAt:new Date('2024-11-18') },
  { id:'p3', titre:'BTP Connect', description:'Construction materials marketplace', status:'completed', progression:100, entrepreneurId:'u2', etapes:[], createdAt:new Date('2023-06-01'), updatedAt:new Date('2024-10-01') },
  { id:'p4', titre:'AgriSmart', description:'IoT for connected agriculture', status:'suspended', progression:20, entrepreneurId:'u2', coachId:'u3', etapes:[], createdAt:new Date('2024-08-01'), updatedAt:new Date('2024-11-01') },
];
