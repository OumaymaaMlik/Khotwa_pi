...
export class LayoutCoachComponent implements OnInit, OnDestroy {
  ...
  /** Nombre de projets en attente de validation (badge dynamique) */
  pendingCount = 0;
  ...
  svgIcons: Record<string, string> = {
    ...
    logout:    '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>',
     events: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="3" y1="14" x2="9" y2="14"/></svg>`,
  };
  ...
  /** Charge le nombre de projets en attente de validation pour le badge. */
  private loadPendingCount(): void {
    this.projetService.getProjetsCoach().subscribe({
      next: (projets) => {
        this.pendingCount = projets.filter(p =>
